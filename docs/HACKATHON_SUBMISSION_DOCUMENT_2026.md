# CHATGPT CODEX INDIA HACKATHON 2026 — OFFICIAL SUBMISSION DOCUMENT
...
**Live Production URL**: [https://attrisense-ai.vercel.app](https://attrisense-ai.vercel.app)  
**GitHub Repository**: [https://github.com/shiveek/AttriSense-AI](https://github.com/shiveek/AttriSense-AI)  
...
Unwanted employee turnover represents a multi-billion-dollar annual drain on enterprise organizations. Replacing a single departing employee costs between $1.5\times$ and $2.0\times$ their annual base salary due to lost productivity, recruiting overhead, and onboarding delays. Traditional Human Resource (HR) operations rely on reactive instruments like exit interviews, which capture employee feedback only after resignation notices have been submitted.
...
1. **Massive Financial Drain**: Replacing technical talent costs up to $2.0\times$ annual salary. For a 500-person enterprise, a 15% attrition rate results in over $5 Million in annual turnover losses.
